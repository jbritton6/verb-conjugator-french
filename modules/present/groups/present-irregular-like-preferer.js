 ...
 * the verb 'preferer' (change in the accent) in a given person.
 ...
 */
export function presentIrregularLikePreferer(verb, person) {
    let conjugatedVerb = '';
    let accentPos = verb.lastIndexOf('é');

    switch(person) {
        case 'singular-1st':
            conjugatedVerb = verb.slice(0, accentPos)
                + 'è' + verb.slice(accentPos + 1, -2) + 'e';
            break;
        case 'singular-2nd':
            conjugatedVerb = verb.slice(0, accentPos)
                + 'è' + verb.slice(accentPos + 1, -2) + 'es';
            break;
        case 'singular-3rd':
            conjugatedVerb = verb.slice(0, accentPos)
                + 'è' + verb.slice(accentPos + 1, -2) + 'e';
        ...
        case 'plural-3rd':
            conjugatedVerb = verb.slice(0, accentPos)
                + 'è' + verb.slice(accentPos + 1, -2) + 'ent';
            break;
    }
