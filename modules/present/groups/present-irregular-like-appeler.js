 ...
 * the verb 'appeler' (doubling of a consonant) in a given person.
 ...
 */
export function presentIrregularLikeAppeler(verb, person) {
    let conjugatedVerb = '';

    switch(person) {
        case 'singular-1st':
            conjugatedVerb = verb.slice(0, -2) + verb.slice(-3, -2) + 'e';
            break;
        case 'singular-2nd':
            conjugatedVerb = verb.slice(0, -2) + verb.slice(-3, -2) + 'es';
            break;
        case 'singular-3rd':
            conjugatedVerb = verb.slice(0, -2) + verb.slice(-3, -2) + 'e';
            break;
        ...
        case 'plural-2nd':
            ...
            break;
        case 'plural-3rd':
            conjugatedVerb = verb.slice(0, -2) + verb.slice(-3, -2) + 'ent';
            break;
    }
